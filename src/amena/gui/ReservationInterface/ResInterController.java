       ...
       ReservationCRUD rc =  new ReservationCRUD() ;
        ...
        for (int i = 0; i < lv2.size(); i++) {
            if (lv2.get(i).isEtat() != true) {
                ...
                lmd.add(new MyDataRes(lv2.get(i).getIdRes(), lv2.get(i).getDate_deb().toString(), lv2.get(i).getDate_fin().toString(),new Image("http://localhost/imageAmena/location/warning.png"),lv2.get(i).getIdTrans(),lv2.get(i).getIdVeh()));
            }
        }
