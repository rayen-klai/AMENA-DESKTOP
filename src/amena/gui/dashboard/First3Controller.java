 ...
 */
package amena.gui.dashboard;



import amena.gui.DashboardTransporteur.DashboardController;
...
public class First3Controller implements Initializable {
     @FXML
    ...
    @FXML
    private void gamificationBtn(ActionEvent event) {
        try
        {
            Parent sv ;
            sv = (AnchorPane)FXMLLoader.load(getClass().getResource("/digidreamers/amena/gui/GestionGamification.fxml"));
          pane4.getChildren().removeAll() ; 
          pane4.getChildren().setAll(sv) ;                              
        } catch (IOException ex) {
             Logger.getLogger(First3Controller.class.getName()).log(Level.SEVERE, null, ex);
    ...
    @FXML
    private void annoncebtn(ActionEvent event) {
         try
        {
            Parent sv ;
            sv = (AnchorPane)FXMLLoader.load(getClass().getResource("/gui/Supprimer.fxml"));
          pane4.getChildren().removeAll() ; 
          pane4.getChildren().setAll(sv) ;                              
        } catch (IOException ex) {
             Logger.getLogger(First3Controller.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnu(ActionEvent event) {
        ...
        {
            Parent sv ;
            sv = (AnchorPane)FXMLLoader.load(getClass().getResource("/amena/gui/UpdateProfil.fxml"));
          pane4.getChildren().removeAll() ; 
          pane4.getChildren().setAll(sv) ;                              
        } catch (IOException ex) {
             Logger.getLogger(First3Controller.class.getName()).log(Level.SEVERE, null, ex);
    ...
    @FXML
    private void dxn(ActionEvent event) {
                      System.exit(0);
