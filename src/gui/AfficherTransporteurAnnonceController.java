 ...
 * @author Nour Saidi
 */
public class AfficherTransporteurAnnonceController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            // String Ty="Demande";
            List<Annonce> list = AC.AfficherD();
                ...
                btnInteresse.setOnAction(event -> {
                    if (annonce.getType().equals("Demande")) {
                        ...
                        try {
                            ...
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("/amena/gui/profilDec.fxml"));
                            test = annonce.getId_annonce();
